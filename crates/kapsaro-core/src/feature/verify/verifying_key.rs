...
//! Verifying key construction for signature verification.
...
/// Result of building a verifying key from a signature
#[derive(Debug)]
...
/// Build a verifying key from a signature's embedded signer_pub.
///
/// Expired keys are allowed for verification but generate a warning.
pub fn build_verifying_key_from_signature(
...
#[cfg(test)]
#[path = "../../../tests/unit/internal/feature_verify_verifying_key_internal_test.rs"]
mod feature_verify_verifying_key_internal_test;

#[cfg(test)]
#[path = "../../../tests/unit/internal/feature_verify_verifying_key_test.rs"]
mod feature_verify_verifying_key_test;
