...
//! PrivateKey v7 model.
//!
//! SSH Ed25519 encrypted private key storage for kapsaro.

use serde::{Deserialize, Serialize};
use zeroize::Zeroize;

/// PrivateKey v7 document (encrypted).
...
pub struct PrivateKeyProtected {
    /// Format identifier: "kapsaro:format:private-key@1"
    pub format: String,
...
///
/// Kapsaro v3 plaintext key material uses:
/// - `crv = "X25519"` for KEM
