...
use kapsaro_core::cli_api::test_support::operations::decrypt::file::{
...
use kapsaro_core::cli_api::test_support::operations::verify::file::{
...
use kapsaro_core::cli_api::test_support::wire::content::FileEncContent;
...
fn test_parse_verify_decrypt_file() {
    ...
    let file_doc: kapsaro_core::cli_api::test_support::domain::file_enc::FileEncDocument =
...
fn build_encrypted_file_for_error_tests() -> (
    kapsaro_core::cli_api::test_support::domain::file_enc::FileEncDocument,
    CryptoContext,
    String, // kid
    TempDir,
) {
...
fn wrap_as_verified(
    doc: kapsaro_core::cli_api::test_support::domain::file_enc::FileEncDocument,
    kid: &str,
