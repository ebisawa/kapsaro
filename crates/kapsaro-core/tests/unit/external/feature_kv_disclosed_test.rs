...
use kapsaro_core::cli_api::test_support::domain::kv_enc::line::KvEncLine;
...
use kapsaro_core::cli_api::test_support::wire::content::{EncContent, KvEncContent};
use kapsaro_core::cli_api::test_support::wire::kv::document::parse_kv_document;
use kapsaro_core::cli_api::test_support::wire::schema::document::parse_kv_entry_token;
...
fn single_rewrap_request<'a>(
    ...
    let target_members = workspace_root
        .map(|workspace_root| {
            let public_keys =
                kapsaro_core::cli_api::test_support::storage::workspace::members::load_active_member_files(
                    workspace_root,
                )
                .unwrap();
