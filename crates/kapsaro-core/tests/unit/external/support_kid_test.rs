...
const DISPLAY_KID: &str = "RDVW-SZ1Q-TMF4-A4RX-58T9-A5W0-YSXK-CR8B";
const HALF_DISPLAY_KID: &str = "RDVW-SZ1Q-TMF4-A4RX";
...
fn test_normalize_kid_query_accepts_prefix_and_display_form() {
    assert_eq!(normalize_kid_query("rdvw-sz").unwrap(), "RDVWSZ");
...
fn test_resolve_unique_kid_accepts_unique_prefix() {
    let candidates = [
        "RDVWSZ1QTMF4A4RX58T9A5W0YSXKCR8B",
        "83ZZEQ3M7S8KHTT3WAA8DW46QYTA93XE",
    ];

    let resolved = resolve_unique_kid(candidates, "rdvw-sz").unwrap();
