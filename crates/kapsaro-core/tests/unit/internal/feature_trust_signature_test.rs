...
) -> (crate::model::public_key::PublicKey, String) {
    use crate::feature::key::public_key_document::{build_public_key, PublicKeyDocumentParams};
    use crate::model::public_key::{Attestation, IdentityKeys, JwkOkpPublicKey};
    use crate::model::wire::jwk;
...
fn test_sign_trust_store_produces_valid_document() {
    ...
    assert_eq!(doc.protected.format, LOCAL_TRUST_V1);
