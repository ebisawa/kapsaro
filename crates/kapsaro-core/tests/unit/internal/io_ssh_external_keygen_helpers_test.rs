...
use super::{
    build_derive_public_key_args, build_sign_args, enforce_sign_output_success,
    execute_sign_command, parse_sign_stdout,
};
use crate::format::codec::format_codec_base64_fixtures::encode_base64_standard;
...
fn test_check_sign_output_failure_public_key_hint() {
    ...
    let err = enforce_sign_output_success(&output, true).expect_err("non-zero exit must fail");
