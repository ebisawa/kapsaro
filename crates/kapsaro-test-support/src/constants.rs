...
//! Common test member handle constants shared across workspace test crates.
//! Includes all test personas used in unit and integration tests.
...
pub const DAVE_MEMBER_HANDLE: &str = "dave@example.com";
