...
use crate::feature::recipient::{build_new_wrap_items, replace_recipient_wrap_items};
...
pub(in crate::feature::rewrap) fn add_kv_recipients(
    sid: &Uuid,
...
pub(in crate::feature::rewrap) fn rewrite_kv_recipient_wraps(
    sid: &Uuid,
    wrap_data: &mut KvWrap,
