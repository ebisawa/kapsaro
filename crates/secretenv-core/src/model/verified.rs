...
///
/// ```ignore
/// use secretenv_core::model::verified::VerifiedPrivateKey;
/// use secretenv_core::model::private_key::PrivateKeyPlaintext;
/// use secretenv_core::io::ssh::backend::SignatureBackend;
///
...
/// #                            _debug: bool|
/// #  -> Result<{ secretenv_core::feature::context::crypto::CryptoContext }, Box<dyn std::error::Error>> { todo!() };
