...
use secretenv_core::cli_api::test_support::storage::ssh::protocol::base64::decode_base64_armored;
use secretenv_core::cli_api::test_support::storage::ssh::protocol::sshsig;
use secretenv_core::cli_api::test_support::storage::ssh::protocol::types::Ed25519RawSignature;
use secretenv_core::cli_api::test_support::storage::ssh::protocol::wire::decode_ssh_string;
...
fn load_ed25519_secret_key(ssh_key_path: &Path) -> Result<[u8; 32]> {
    let armored = fs::read_to_string(ssh_key_path).map_err(|e| {
        secretenv_core::Error::build_ssh_error_with_source(
...
fn unsupported_ssh_key(message: impl Into<String>) -> secretenv_core::Error {
    secretenv_core::Error::build_ssh_error(message.into())
}
