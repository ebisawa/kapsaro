...
#[test]
fn test_parse_header_v9() {
    let parsed = KvEncParser::parse_line(":SECRETENV_KV 9").unwrap();
    assert_eq!(
        parsed,
        KvEncLine::Header {
