...
use super::{build_trust_store_reset_plan, execute_trust_store_reset, TrustStoreResetPlan};
...
fn test_build_trust_store_reset_plan_resolves_delete_target() {
    ...
    let plan = build_trust_store_reset_plan(
        &options,
        "alice@example.com",
...
fn test_build_trust_store_reset_plan_noninteractive_fails_without_deleting() {
    ...
    let error = build_trust_store_reset_plan(
        &options,
        "alice@example.com",
        build_reset_required_error(),
        false,
