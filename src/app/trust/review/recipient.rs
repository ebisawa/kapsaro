...
pub(crate) fn review_recipient_trust_with_confirmation<ConfirmRecipients>(
...
pub(crate) fn review_recipient_trust_with_confirmation_verifier<VerifyOnline, ConfirmRecipients>(
    outcome: &RecipientTrustOutcome,
    context_label: &str,
