...
use kapsaro_core::test_support::helpers::kid::format_kid_half_display;
...
#[cfg(unix)]
#[test]
fn test_get_skips_known_signer_review_when_strict_checking_is_disabled() {
    ...
    cmd()
        ...
        .assert()
        .success()
        .stdout(predicate::str::contains("must-not-print"))
