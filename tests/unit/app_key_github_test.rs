...
fn test_key_new_result_github_verification_not_configured_by_default() {
    // KeyGenerationResult.github_verification must be OnlineVerificationStatus::NotConfigured
    ...
    // Verify the field access compiles: KeyGenerationResult must have github_verification
    fn assert_has_expected_fields(
        r: &KeyGenerationResult,
    ) -> (
        &str,
        &str,
        &str,
