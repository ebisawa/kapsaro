...
use secretenv::feature::trust::known_keys::{
    add_known_key, assess_known_key, find_known_key, purge_known_keys, remove_known_key,
    validate_kid_integrity, KnownKeyAssessment,
};
...
fn make_key(kid: &str, member_id: &str) -> KnownKey {
    KnownKey {
        kid: kid.to_string(),
